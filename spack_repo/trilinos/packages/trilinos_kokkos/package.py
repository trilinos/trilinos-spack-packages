...
class TrilinosKokkos(TrilinosBaseClass):
    ...
    def generated_trilinos_package_cmake_args(self):
        ...
        trilinos_package_auto_cmake_args.append(self.define_from_variant('TRILINOS_TPL_ENABLE_DLlib', 'dllib'))

        trilinos_package_auto_cmake_args.append(self.define_from_variant('TRILINOS_TPL_ENABLE_HWLOC', 'hwloc'))

        trilinos_package_auto_cmake_args.append(self.define_from_variant('TRILINOS_TPL_ENABLE_Pthread', 'pthread'))
